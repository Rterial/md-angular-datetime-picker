                          ...
                          '<md-dialog-content layout="row" layout-wrap>' +
                            ...
                            '<div layout="column" layout-align="start center" class="md-datepicker-calendar">' +
                              '<div layout="row" layout-align="space-between center" class="md-datepicker-monthyear">' +
                                '<md-button aria-label="mese precedente" class="md-icon-button" ng-click="datepicker.prevMonth()"><md-icon md-font-set="material-icons"> &lt; </md-icon></md-button>' +
                                '{{ datepicker.currentMoment.format("MMMM YYYY") }}' +
                                '<md-button aria-label="mese successivo" class="md-icon-button" ng-click="datepicker.nextMonth()"><md-icon md-font-set="material-icons"> &gt; </md-icon></md-button>' +
                              '</div>' +
                            ...
                            '</div>' +
                          '</md-dialog-content>' +
                          '<div class="md-actions" layout="row" layout-align="center center" layout-fill>' +
